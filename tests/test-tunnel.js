...
function addTests() {
  ...
  runTest(
    ...
    ["http connect to localhost:" + s.port, "http response", "200 http ok"]
  );
  ...
  runTest(
    ...
    ["https connect to localhost:" + s.port, "http response", "200 http ok"]
  );
  ...
  runTest(
    ...
    ["http connect to localhost:" + ss.port, "https response", "200 https ok"]
  );
  ...
  runTest(
    ...
    ["https connect to localhost:" + ss.port, "https response", "200 https ok"]
  );
  ...
  runTest(
    ...
    ["http connect to localhost:" + ss2.port, "https response", "200 https ok"]
  );
