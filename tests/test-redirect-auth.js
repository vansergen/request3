...
function addTests() {
  ...
  runTest(
    "different host same protocol",
    redirect.from("https", "127.0.0.1").to("https", "localhost"),
    false
  );

  runTest(
    "different host and protocol",
